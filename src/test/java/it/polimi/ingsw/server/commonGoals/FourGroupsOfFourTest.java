...
class FourGroupsOfFourTest {
    ...
    void testTrue() throws JsonBadParsingException {
        Shelf trueShelf = new Shelf(Shelf.pathToJSONObject("src/test/resources/CommonGoalTests/TestShelf_1_4groupsOf4.json"));
        CommonGoal to_test = CommonGoalsFactory.create_goal_with_ID(11, 2);
        assertTrue(to_test.getID() == 11);
    ...
    void testFalse() throws JsonBadParsingException {
        Shelf falseShelf = new Shelf(Shelf.pathToJSONObject("src/test/resources/CommonGoalTests/TestShelf_2_4groupsOf4.json"));
        CommonGoal to_test = CommonGoalsFactory.create_goal_with_ID(11,2);
        assertTrue(to_test.getID() == 11);
